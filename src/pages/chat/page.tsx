...
// Summarize tool input for collapsed header
...
function ToolResultContent({ tool }: { tool: ToolBlockState }) {
  ...
  // Bash — render as terminal output
  if (tool.name === 'bash') {
    return (
  ...
  // File read — syntax-highlighted code block
  ...
  // Web search / firecrawl search — render structured results
  ...
  // Firecrawl scrape / web fetch — render as readable article
...
function ToolBlock({ tool }: { tool: ToolBlockState }) {
  ...
  return (
    <div className={cn(
      ...
      {/* Show input on expand only for non-obvious tools */}
